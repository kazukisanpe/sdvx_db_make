...
for search_pref_ in range(len(search_pref_all)):
    ...
    for num in range(len(elems)):
        ...
        #print(store_info)
        # データの挿入
        c.execute("INSERT INTO store VALUES (" + str(cnt) + ",'" + store_info[1] + "', '" + store_info[2] + "', '" + store_info[3] + "', '" + store_info[4] + "', '" + store_info[5] + "', '" + store_info[6] + "', '" + store_info[7] + "', '" + store_info[8] + "')")
...
print(str(cnt) + "件の情報をsdvx.storeにINSERTしました。")
